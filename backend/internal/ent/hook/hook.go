...
// The CaseMemberFunc type is an adapter to allow the use of ordinary
// function as CaseMember mutator.
type CaseMemberFunc func(context.Context, *ent.CaseMemberMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f CaseMemberFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.CaseMemberMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.CaseMemberMutation", m)
}

// The CaseRecordFunc type is an adapter to allow the use of ordinary
// function as CaseRecord mutator.
type CaseRecordFunc func(context.Context, *ent.CaseRecordMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f CaseRecordFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.CaseRecordMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.CaseRecordMutation", m)
}
