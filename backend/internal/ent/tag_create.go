...
func (_c *TagCreate) AddCaseIDs(ids ...int) *TagCreate {
	_c.mutation.AddCaseIDs(ids...)
	return _c
}

// AddCases adds the "cases" edges to the CaseRecord entity.
func (_c *TagCreate) AddCases(v ...*CaseRecord) *TagCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *TagCreate) AddEvidenceIDs(ids ...int) *TagCreate {
	_c.mutation.AddEvidenceIDs(ids...)
	return _c
}

// AddEvidence adds the "evidence" edges to the Evidence entity.
func (_c *TagCreate) AddEvidence(v ...*Evidence) *TagCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
