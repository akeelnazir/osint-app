...
func HasCasesWith(preds ...predicate.CaseRecord) predicate.Tag {
	return predicate.Tag(func(s *sql.Selector) {
		step := newCasesStep()
...
func HasEvidence() predicate.Tag {
	return predicate.Tag(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasEvidenceWith(preds ...predicate.Evidence) predicate.Tag {
	return predicate.Tag(func(s *sql.Selector) {
