...
func (_c *CommentCreate) SetMentions(v []string) *CommentCreate {
...
func (_c *CommentCreate) SetCaseID(id int) *CommentCreate {
...
func (_c *CommentCreate) SetNillableCaseID(id *int) *CommentCreate {
	if id != nil {
		_c = _c.SetCaseID(*id)
	}
	return _c
...
func (_c *CommentCreate) SetCase(v *CaseRecord) *CommentCreate {
	return _c.SetCaseID(v.ID)
}

// SetEvidenceID sets the "evidence" edge to the Evidence entity by ID.
func (_c *CommentCreate) SetEvidenceID(id int) *CommentCreate {
...
func (_c *CommentCreate) SetNillableEvidenceID(id *int) *CommentCreate {
	if id != nil {
...
func (_c *CommentCreate) SetEvidence(v *Evidence) *CommentCreate {
...
func (_c *CommentCreate) createSpec() (*Comment, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.CaseIDs(); len(nodes) > 0 {
		...
		_node.case_record_comments = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
